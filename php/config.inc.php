...
$config['smtp_user'] 			= 'hansh5037@naver.com'; 			// you@gmail.com
$config['smtp_pass'] 			= 'gkstjgml1106!';				// password
$config['smtp_ssl']				= true;						// true for google (port 465), false for others

// Who receive all emails?
$config['send_to']				= 'hansh5037@naver.com';			// destination of all emails sent throught contact form
